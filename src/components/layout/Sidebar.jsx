...
import { LayoutDashboard, Search, Zap, FolderOpen, Settings, Shield, CheckCircle } from 'lucide-react';
...
export function Sidebar() {
    return (
        <div className="flex h-screen w-64 flex-col border-r bg-card text-card-foreground hidden md:flex">
