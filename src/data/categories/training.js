export const training = {
    ...
    tools: [
        ...
        { id: 'syk_research_cases', name: 'Something You Know – Case Studies', url: 'https://somethingyouknow.io/osint-in-depth-case-studies/', description: 'Historias de investigación OSINT criminal (Nivel de detalle en resolución: Alto). Idioma: Inglés.', category: 'training', free: true },
